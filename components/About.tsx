        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
              We define the <br/>
              <span className="text-brand-purple">Future of Brand</span>
            </h2>
            <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
              <p>
                <strong className="text-white">딩 스튜디오</strong>는 단순한 에이전시가 아닙니다. 
                우리는 클라이언트의 비즈니스를 깊이 이해하고, 가장 적합한 크리에이티브 솔루션을 제안하는 파트너입니다.
              </p>
              <p>
              ...
              <div className="grid grid-cols-2 gap-8 pt-8 border-t border-white/10 mt-8">
                <div>
                  ...
                  <span className="text-sm">프로젝트 완료</span>
                </div>
                <div>
                  <h4 className="text-3xl font-bold text-brand-neon mb-1">98%</h4>
                  <span className="text-sm">클라이언트 만족도</span>
                </div>
              </div>
            </div>
          </div>
